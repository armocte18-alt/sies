...
class UpdateVehiculoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'placa' => ['required', 'string', 'max:15', Rule::unique('vehiculos', 'placa')->ignore($this->route('vehiculo'))],
            ...
            'estatus' => ['required', Rule::in(['disponible', 'mantenimiento', 'fuera_de_servicio'])],
        ];
    }
