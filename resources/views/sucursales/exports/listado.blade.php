<table>
    ...
    <tr><td colspan="6">&nbsp;</td></tr>
    <tr><td colspan="6" style="font-weight:bold; font-size:16pt; color:#135c46;">DIRECTORIO DE SUCURSALES DE LA GERENCIA ESTATAL EN LA CIUDAD DE MÉXICO</td></tr>
    <tr><td colspan="6" style="font-style:italic; font-size:10pt; color:#4B5563;">{{ $filtrosResumen }}</td></tr>
    <tr><td colspan="6">&nbsp;</td></tr>
    <tr>
        <td style="background-color:#135c46; color:#ffffff; font-weight:bold;">Registro</td>
        <td style="background-color:#135c46; color:#ffffff; font-weight:bold;">Administración</td>
        <td style="background-color:#135c46; color:#ffffff; font-weight:bold;">Ubicación</td>
        <td style="background-color:#135c46; color:#ffffff; font-weight:bold;">Alcaldía</td>
        <td style="background-color:#135c46; color:#ffffff; font-weight:bold;">Horario</td>
        <td style="background-color:#135c46; color:#ffffff; font-weight:bold;">Titular</td>
    </tr>
    @foreach ($sucursales as $sucursal)
        ...
        @for ($i = 0; $i < $filas; $i++)
            <tr>
                ...
                @endif
                <td style="color: {{ $i === 0 ? '#135c46' : '#9CA3AF' }}; vertical-align:top;">{{ $ubic[$i] ?? '' }}</td>
                @if ($i === 0)
